                    ...
                    <ul className="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                        ...
                        <li className="nav-item ms-2 dropdown">
                            <a className="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button"
                               ...
                               aria-expanded="false">
                                <img className="avatar-img rounded-2" src={account.avatar}
                                     style={{borderRadius: "30px"}} alt=""/>
                            </a>
                            <ul className="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3"
                                ...
                                <li className="px-3">
                                    <div className="d-flex align-items-center position-relative">
                                        ...
                                        <div>
                                            <a className="h6 stretched-link" href="#">{account.name}</a>
                                            <p className="small m-0">Web Developer</p>
                                        </div>
                                    </div>
                                    <Link className="dropdown-item btn btn-primary-soft btn-sm my-2 text-center"
                                          to={`/home/PersonalPage/MyTimeline/${account.idAccount}`}>View
                                        profile</Link>
                                </li>
